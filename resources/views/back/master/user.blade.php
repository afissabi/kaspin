        ...
        <div class="modal-content" style="width: 125%;">
            ...
            <div class="modal-body">
                <form method="post" class="kt-form kt-form--label-right" id="form">
                    ...
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Jabatan User :</label>
                        <div class="col-lg-8 col-xl-8">
                            <select class="form-select" data-control="select2" name="jabatan">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-4 col-xl-2">
                            <label class="form-check form-switch form-check-custom form-check-solid">
                                ...
                                <input class="form-check-input" name="aktif_user" type="checkbox" value="1" checked="checked" />
